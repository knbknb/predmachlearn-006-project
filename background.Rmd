---
title: "predmachlearn-006-project-background"
...
The goal of the project is to predict the manner in which they did the exercise. This is the "classe" variable in the training set. You may use any of the other variables to predict with. 
  ...
  - how you used cross validation, what you think the expected out of sample error is, and 
...
Please read the [analysis](project-weightliftingdata.html) to continue.
